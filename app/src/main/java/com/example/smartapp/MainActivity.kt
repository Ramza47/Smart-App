...
class MainActivity : AppCompatActivity() {
    ...
    private fun clearFields(dateEditText: EditText?, morningScreenTimeEditText: EditText?, afternoonScreenTimeEditText: EditText?, activityNotesEditText: EditText?) {
